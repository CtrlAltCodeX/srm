...
if (!isset($_SESSION['USER'])) {
  header("Location: ../../");
} else if (!($_SESSION['USER'] == "MNOS") && !($_SESSION['USER'] == "SDA") && !($_SESSION['USER'] == "CEO") && !($_SESSION['USER'] == "EXECUTIVE") && !($_SESSION['USER'] == "GMATM") && !($_SESSION['USER'] == "GMAI") && !($_SESSION['USER'] == "GMA")) {
  header("Location: ../../");
}
$pageuser = "MNOS";
...
<head>
  ...
  <title>SRM PORTAL | <?PHP echo $pageuser; ?></title>
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            <a href="../../pages/MNOS/apmnadashboard.php"><i class="fa fa-dashboard"></i> MNOS
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li class="active"><a href="apmnadashboard.php"><i class="fa fa-circle-o"></i>DASHBOARD</a></li>
