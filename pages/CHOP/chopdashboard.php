...
if (!isset($_SESSION['USER'])) {
  header("Location: ../../");
} else if (!($_SESSION['USER'] == "HOP") && !($_SESSION['USER'] == "SDA") && !($_SESSION['USER'] == "EXECUTIVE") && !($_SESSION['USER'] == "GMATM") && !($_SESSION['USER'] == "CEO")) {
  header("Location: ../../");
}
$pageuser = "HOP";
?>
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            <a href="../../pages/HOP/chopdashboard.php"><i class="fa fa-dashboard"></i> HOP
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li class="active"><a href="chopdashboard.php"><i class="fa fa-circle-o"></i>DASHBOARD</a></li>
