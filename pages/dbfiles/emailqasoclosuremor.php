...
$result = mysqli_query($db,"SELECT QASO FROM mor WHERE MORID='$id'");
if (!$result) 
{
...
$mail = new PHPMailer();
$subject = "New MOR with QASO";
$content = "<b>Bula QASO ".$qaso." </br><br>You have a closed MOR Id: ".$id.", Please conduct review for closure by logging in at : http://10.99.100.29/srm/index.html</b>";
$mail->IsSMTP();
$mail->SMTPDebug = 3;
$mail->SMTPAuth = TRUE;
$mail->SMTPSecure = "tls";
