...
$result = mysqli_query($db, "SELECT QASO FROM AUDIT WHERE AID='$id'");
if (!$result) {
    echo 'Could not run query: ' . mysql_error($db);
    exit;
}
...
$mail = new PHPMailer();
$subject = "New AUDIT with QASO";
$content = "<b>Bula QASO " . $qaso . " </br><br>You have a closed AUDIT Recommendation, Please conduct review for closure by logging in at: http://10.99.100.29/srm/index.html</b>";
$mail->IsSMTP();
$mail->SMTPDebug = 3;
$mail->SMTPAuth = TRUE;
$mail->SMTPSecure = "tls";
