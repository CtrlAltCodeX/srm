...
if (!isset($_SESSION['USER'])) {
  header("Location: ../../");
} else if (!($_SESSION['USER'] == "QASO-ATSP") && !($_SESSION['USER'] == "SDA") && !($_SESSION['USER'] == "EXECUTIVE") && !($_SESSION['USER'] == "CEO")) {
  header("Location: ../../");
}
$pageuser = "ATSP";
?>
...
<head>
  ...
  <title>SRM PORTAL | QASO-ATSP</title>
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              <li class="active"><a href="atspdashboard.php"><i class="fa fa-circle-o"></i> DASHBOARD</a></li>

              <li><a href="atspaudit.php"><i class="fa fa-circle-o"></i> AUDIT FORM</a></li>
              <li><a href="atspdatatables.php"><i class="fa fa-circle-o"></i> DATA ALL OPEN</a></li>
