...
{
 header("Location: ../../");
}else if (!($_SESSION['USER'] == "QASO-ATSP") && !($_SESSION['USER'] == "SDA") && !($_SESSION['USER'] == "EXECUTIVE"))
{
	header("Location: ../../");
}
$pageuser="ATSP";
  ...
  <ul class="sidebar-menu">
     ...
     <li class="treeview active">
              ...
              <ul class="treeview-menu">
               <li><a href="atspdashboard.php"><i class="fa fa-circle-o"></i> DASHBOARD</a></li>
								
								<li ><a href="atspaudit.php"><i class="fa fa-circle-o"></i> AUDIT FORM</a></li>
				<li  class="active"><a href="atspdatatables.php"><i class="fa fa-circle-o"></i> DATA ALL OPEN</a></li>
				<li ><a href="atspdatatables2.php"><i class="fa fa-circle-o"></i> DATA ALL CLOSED</a></li>
