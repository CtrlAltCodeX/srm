...
if (!isset($_SESSION['USER'])) {
  header("Location: ../../");
} else if (!($_SESSION['USER'] == "QASO-EM") && !($_SESSION['USER'] == "SDA") && !($_SESSION['USER'] == "EXECUTIVE") && !($_SESSION['USER'] == "GMAI") && !($_SESSION['USER'] == "CEO")) {
  header("Location: ../../");
}
...
<head>
  ...
  <title>SRM PORTAL | QASO-ElectricalMechanical</title>
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              <li class="active"><a href="emdashboard.php"><i class="fa fa-circle-o"></i> DASHBOARD</a></li>
              ...
              <li><a href="emdatatables.php"><i class="fa fa-circle-o"></i> DATA ALL OPEN</a></li>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="alert alert-danger alert-dismissible" id="verybadmodel">
              <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
              <h4><i class="icon fa fa-ban"></i> Failed!</h4>Something went wrong. Please contact developer.
            </div>
