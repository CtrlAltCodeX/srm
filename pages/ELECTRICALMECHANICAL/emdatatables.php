...
{
 header("Location: ../../");
}else if (!($_SESSION['USER'] == "QASO-EM") && !($_SESSION['USER'] == "SDA") && !($_SESSION['USER'] == "EXECUTIVE"))
{
	header("Location: ../../");
}
...
<div class="wrapper">
  ...
  <ul class="sidebar-menu">
     ...
     <li class="treeview active">
              <a href="#"><i class="fa fa-dashboard"></i> QASO-ElectricalMechanical
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
              <li ><a href="emdashboard.php"><i class="fa fa-circle-o"></i> DASHBOARD</a></li>
				<li ><a href="emaudit.php"><i class="fa fa-circle-o"></i>AUDIT FORM</a></li>
				<li ><a href="emcompliance.php"><i class="fa fa-circle-o"></i> COMPLIANCE</a></li>
				<li  class="active"><a href="firedatatables.php"><i class="fa fa-circle-o"></i> DATA ALL OPEN</a></li>
				<li ><a href="emdatatables2.php"><i class="fa fa-circle-o"></i> DATA ALL CLOSED</a></li>
        ...
        <!-- left column -->
		 ...
		 <div class="col-xs-12">
			...
			<div class="alert alert-danger alert-dismissible" id="verybadmodel">
                ...
                Something went really wrong. Please contact Systems Administrator.
              </div>
