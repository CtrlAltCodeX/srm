...
<head>
  ...
  <title>SRM PORTAL | QASO-EM</title>
      ...
      <ul class="sidebar-menu">
	   <li class="header">MAIN NAVIGATION</li>
        <li class="treeview active">
              <a href="../../pages/MSRM/msrmdashboard.php"><i class="fa fa-dashboard"></i> QASO-EM
              ...
              <ul class="treeview-menu">
				...
				<li class="active"><a href="emcompliance.php"><i class="fa fa-circle-o"></i> COMPLIANCE</a></li>
