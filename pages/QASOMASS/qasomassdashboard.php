...
<head>
  ...
  <title>SRM PORTAL | QASO-MASS</title>
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            <a href="#"><i class="fa fa-dashboard"></i> QASO-MASS
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li class="active"><a href="qasomassdashboard.php"><i class="fa fa-circle-o"></i> DASHBOARD</a></li>
