     ...
     <li class="treeview active">
              ...
              <ul class="treeview-menu">
               <li ><a href="qasomassdashboard.php"><i class="fa fa-circle-o"></i> DASHBOARD</a></li>
				...
				<li  class="active"><a href="massdatatables.php"><i class="fa fa-circle-o"></i> DATA ALL OPEN</a></li>
				<li ><a href="massdatatables2.php"><i class="fa fa-circle-o"></i> DATA ALL CLOSED</a></li>
