...
if (!isset($_SESSION['USER'])) {
  header("Location: ../../");
} else if (!($_SESSION['USER'] == "MALOCS123") && !($_SESSION['USER'] == "SDA") && !($_SESSION['USER'] == "CEO") && !($_SESSION['USER'] == "GMATM") && !($_SESSION['USER'] == "EXECUTIVE") && !($_SESSION['USER'] == "GMA")) {
  header("Location: ../../");
}
$pageuser = "MALOCS";
?>
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            <a href="../../pages/MALOCS/malocsdashboard.php"><i class="fa fa-dashboard"></i> MALOCS
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li class="active"><a href="malocsdashboard.php"><i class="fa fa-circle-o"></i>DASHBOARD</a></li>
