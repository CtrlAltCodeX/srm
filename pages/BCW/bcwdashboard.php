...
if (!isset($_SESSION['USER'])) {
  header("Location: ../../");
} else if (!($_SESSION['USER'] == "MBCW") && !($_SESSION['USER'] == "SDA") && !($_SESSION['USER'] == "CEO") && !($_SESSION['USER'] == "EXECUTIVE") && !($_SESSION['USER'] == "GMAI")) {
  header("Location: ../../");
}
$pageuser = "MBCW";
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            <a href="../../pages/MBCW/bcwdashboard.php"><i class="fa fa-dashboard"></i> MBCW
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li class="active"><a href="bcwdashboard.php"><i class="fa fa-circle-o"></i>DASHBOARD</a></li>
