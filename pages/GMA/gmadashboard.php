...
if (!isset($_SESSION['USER'])) {
  header("Location: ../../");
} else if (!($_SESSION['USER'] == "GMA") && !($_SESSION['USER'] == "SDA") && !($_SESSION['USER'] == "EXECUTIVE") && !($_SESSION['USER'] == "CEO")) {
  header("Location: ../../");
}
$pageuser = "GMA";
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li>
            <a href="#"><i class="fa fa-dashboard"></i> <span>GMA</span>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li>
                ...
                <ul class="treeview-menu">
                  <li><a href="../../pages/MALOCS/malocsdashboard.php"><i class="fa fa-circle-o"></i> DASHBOARD</a></li>
            ...
            <div class="box">
              ...
              <div class="box-body" id="tablediv">
                <div class="table-responsive">
                  ...
                  $colors = array("MALOCS", "MAO", "MARFFS", "MASS", "MNOS");
                  $tablerow = "";
