...
if (!isset($_SESSION['USER'])) {
  header("Location: ../../");
} else if (!($_SESSION['USER'] == "MEMS") && !($_SESSION['USER'] == "SDA") && !($_SESSION['USER'] == "EXECUTIVE") && !($_SESSION['USER'] == "GMAI") && !($_SESSION['USER'] == "CEO")) {
  header("Location: ../../");
}
$pageuser = "MEMS";
?>
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            <a href="../../pages/MEMS/memsdashboard.php"><i class="fa fa-dashboard"></i> MEMS
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li class="active"><a href="memsdashboard.php"><i class="fa fa-circle-o"></i>DASHBOARD</a></li>
