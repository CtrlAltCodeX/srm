...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="wrapper">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="sdccomplianceform.php"><i class="fa fa-circle-o"></i> COMPLIANCE FORM</a></li>
            </ul>
          </li>
    ...
    <div class="content-wrapper">
      ...
      <?php
      $pagebox = "../components/complianceform.php";
    ...
    <footer class="main-footer">
      ...
      <strong>Copyright &copy; 2014-2023 <a href="http://almsaeedstudio.com">Fiji Airports</a>.</strong> All rights
      reserved.
    </footer>
  ...
  <script src="../components/compliancejqeury.js"></script>
