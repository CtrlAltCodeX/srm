...
<div class="wrapper">
  ...
  <ul class="sidebar-menu">
     ...
     <li class="treeview active">
              <a href="#"><i class="fa fa-dashboard"></i> QASO-OHS
              ...
              <ul class="treeview-menu">
				...
				<li ><a href="ohsaudit.php"><i class="fa fa-circle-o"></i> AUDIT FORM</a></li>
				<li  class="active"><a href="ohsdatatables.php"><i class="fa fa-circle-o"></i> DATA ALL OPEN</a></li>
