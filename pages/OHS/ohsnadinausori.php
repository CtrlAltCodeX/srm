...
{
 header("Location: ../../");
}else if (!($_SESSION['USER'] == "OHSNAUSORI")&& !($_SESSION['USER'] == "OHSNADI") && !($_SESSION['USER'] == "OHSOUTER") && !($_SESSION['USER'] == "SDA") && !($_SESSION['USER'] == "EXECUTIVE"))
{
	header("Location: ../../");
}
$pageuser="OHS";
  ...
  <ul class="sidebar-menu">
     ...
     <li class="treeview active">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="ohsdashboard.php"><i class="fa fa-circle-o"></i> DASHBOARD</a></li>
      ...
      <div class="row">
        <!-- left column -->
		 ...
		 <div class="col-xs-12">
            ...
            <div class="box-body" id="tablediv">
              <table id="example3" class="table table-bordered table-striped">
				...
				<?php
						...
						if($_SESSION['USER']=="OHSNAUSORI")
						{
								$query = "SELECT *, DATEDIFF(CURDATE(),SDCSUBMITDATE ) as DiffDate, DATEDIFF(CURDATE(),LASTUPDATE) as LastUpdateDiff
						FROM hazardreport  WHERE SDCCHECK='1' AND QASOCHECK='1' AND SDCCHECKTWO='1' AND CLOSEDRO='OPEN' AND QASO='$pageuser' AND AIRPORT='Nausori'";
							}else if ($_SESSION['USER'] == "OHSNADI")
						{
							$query = "SELECT *, DATEDIFF(CURDATE(),SDCSUBMITDATE ) as DiffDate, DATEDIFF(CURDATE(),LASTUPDATE) as LastUpdateDiff
						FROM hazardreport  WHERE SDCCHECK='1' AND QASOCHECK='1' AND SDCCHECKTWO='1' AND CLOSEDRO='OPEN' AND QASO='$pageuser' AND AIRPORT='Nadi'";
						}else if ($_SESSION['USER'] == "OHSOUTER")
						{
							$query = "SELECT *, DATEDIFF(CURDATE(),SDCSUBMITDATE ) as DiffDate, DATEDIFF(CURDATE(),LASTUPDATE) as LastUpdateDiff
						FROM hazardreport  WHERE SDCCHECK='1' AND QASOCHECK='1' AND SDCCHECKTWO='1' AND CLOSEDRO='OPEN' AND QASO='$pageuser' AND AIRPORT<>'Nadi' AND AIRPORT<>'Nausori' ";
						}
						else
						{
							$query = "SELECT *, DATEDIFF(CURDATE(),SDCSUBMITDATE ) as DiffDate, DATEDIFF(CURDATE(),LASTUPDATE) as LastUpdateDiff
						FROM hazardreport  WHERE SDCCHECK='1' AND QASOCHECK='1' AND SDCCHECKTWO='1' AND CLOSEDRO='OPEN' AND QASO='$pageuser'";
						}
			...
			<div class="box-body" id="tablediv">
              <table id="example33" class="table table-bordered table-striped">
				...
				<?php
						...
						FROM mor  WHERE  CLOSEDRO='OPEN'AND QASO='$pageuser' AND AIRPORT='Nausori'";
						}else if ($_SESSION['USER'] == "OHSNADI")
						{
							$query = "SELECT *, DATEDIFF(CURDATE(),LASTUPDATE) as LastUpdateDiff
						FROM mor  WHERE  CLOSEDRO='OPEN'AND QASO='$pageuser' AND AIRPORT='Nadi'";
						}else if ($_SESSION['USER'] == "OHSOUTER")
						{
							$query = "SELECT *, DATEDIFF(CURDATE(),LASTUPDATE) as LastUpdateDiff
						FROM mor  WHERE  CLOSEDRO='OPEN'AND QASO='$pageuser' AND AIRPORT<>'Nadi' AND AIRPORT<>'Nausori' ";
						}
						else
						{
							$query = "SELECT *, DATEDIFF(CURDATE(),LASTUPDATE) as LastUpdateDiff
						FROM mor  WHERE  CLOSEDRO='OPEN'AND QASO='$pageuser'";
						}
			...
			<div class="box-header">
              <h3 class="box-title">All Open Audit Listing</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body" id="tablediv">
              <table id="example66" class="table table-bordered table-striped">
				...
				<?php
						...
						FROM audit  WHERE CLOSEDRO='OPEN' AND QASO='$pageuser' AND AIRPORT='Nausori'";
							}else if ($_SESSION['USER'] == "OHSNADI")
						{
							$query = "SELECT *, DATEDIFF(TARGETDATE,CURDATE()) as DiffDate, DATEDIFF(CURDATE(),LASTUPDATE) as LastUpdateDiff
						FROM audit  WHERE CLOSEDRO='OPEN' AND QASO='$pageuser' AND AIRPORT='Nadi'";
						}else if ($_SESSION['USER'] == "OHSOUTER")
						{
							$query = "SELECT *, DATEDIFF(TARGETDATE,CURDATE()) as DiffDate, DATEDIFF(CURDATE(),LASTUPDATE) as LastUpdateDiff
						FROM audit  WHERE CLOSEDRO='OPEN' AND QASO='$pageuser' AND AIRPORT<>'Nadi' AND AIRPORT<>'Nausori' ";
						}
						else
						{
							$query = "SELECT *, DATEDIFF(TARGETDATE,CURDATE()) as DiffDate, DATEDIFF(CURDATE(),LASTUPDATE) as LastUpdateDiff
						FROM audit  WHERE CLOSEDRO='OPEN' AND QASO='$pageuser'";
						}
...
function updatecompwa() {
		...
		setTimeout(function(){$('#COMPMODALWA').modal('hide')}, 3)
		$('#submitting').show();
