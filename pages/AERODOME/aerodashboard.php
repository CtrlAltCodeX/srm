...
if (!isset($_SESSION['USER'])) {
  header("Location: ../../");
} else if (!($_SESSION['USER'] == "QASO-AERODOME") && !($_SESSION['USER'] == "SDA") && !($_SESSION['USER'] == "CEO") && !($_SESSION['USER'] == "EXECUTIVE") && !($_SESSION['USER'] == "GMATM")) {
  header("Location: ../../");
}
$pageuser = "AERODOME";
?>
...
<head>
  ...
  <title>SRM PORTAL | QASO-AERODOME</title>
...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <nav class="navbar navbar-static-top"><img src="<?= $logo  ?>" height="45px">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            <a href="#"><i class="fa fa-dashboard"></i> QASO-AERODOME
