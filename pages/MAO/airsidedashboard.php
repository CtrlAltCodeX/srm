...
if (!isset($_SESSION['USER'])) {
  header("Location: ../../");
} else if (!($_SESSION['USER'] == "AIRSIDE") && !($_SESSION['USER'] == "SDA") && !($_SESSION['USER'] == "CEO") && !($_SESSION['USER'] == "GMATM") && !($_SESSION['USER'] == "GMA")) {
  header("Location: ../../");
}
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            <a href="#"><i class="fa fa-dashboard"></i> MAO
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li class="active"><a href="airsidedashboard.php"><i class="fa fa-circle-o"></i> DASHBOARD</a></li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="#">Nadi AD</a></li>
          <li><a href="#">Airside</a></li>
