...
{
 header("Location: ../../");
}else if (!($_SESSION['USER'] == "QASO-ENV") && !($_SESSION['USER'] == "SDA") && !($_SESSION['USER'] == "EXECUTIVE"))
{
	header("Location: ../../");
}
  ...
  <ul class="sidebar-menu">
     ...
     <li class="treeview active">
              ...
              <ul class="treeview-menu">
				...
				<li  class="active"><a href="envdatatables.php"><i class="fa fa-circle-o"></i> DATA ALL OPEN</a></li>
