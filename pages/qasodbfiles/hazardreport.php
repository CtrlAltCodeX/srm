...
else if (!($_SESSION['USER'] == "QASO-FIRE") && !($_SESSION['USER'] == "SDA") && !($_SESSION['USER'] == "EXECUTIVE") && !($_SESSION['USER'] == "QASO-AERODOME")&& !($_SESSION['USER'] == "QASO-AMO") && !($_SESSION['USER'] == "QASO-ATSP") && !($_SESSION['USER'] == "QASO-ENV"))
{
	header("Location: ../../");
}
...
$('html, body').animate({ scrollTop: 0 }, 'slow');
	...
	$.ajax({
	type: "POST",
	url: "../submitforms/hazardreportmysql.php",
	...
	// Let's upload the complete file object
		...
		var dataString = 'id=' + id + '&dateoccur=' + dateoccur + '&hitype=' + hitype + '&hid=' + hid + '&potcausetype=' + potcausetype + '&potcaused=' + potcaused + '&effecttype=' + effecttype
					+ '&effectd=' + effectd + '&username=' + username + '&useremail=' + useremail +'&userphone=' + userphone + '&airport=' + airport + '&source='+ source + '&hazorinc='+ hazorinc + '&FileName=' + myFileName + '&FileSize=' + myFileSize + '&FileType=' + myFileType + '&extension=' + extension;
					}
					else
		{
...
// AJAX code to submit form.
					...
					if (hid == ''  || username == '') 
					{
						alert("Please Briefly describe the Hazard, ensure name is filled");
					} 
					else
					{
					 	...
					 	$.ajax({
							type: "POST",
							url: "../submitforms/hazardinsert.php",
							data: dataString,
							cache: false,
...
<script language="javascript" type="text/javascript">
	 ...
	 document.getElementById('hazardform').reset();
	 sortSelect('#airport', 'text', 'asc');
	 sortSelect('#hitype', 'text', 'asc');
	 sortSelect('#causetype', 'text', 'asc');
	 sortSelect('#effecttype', 'text', 'asc');
