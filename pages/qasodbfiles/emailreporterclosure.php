...
$mail = new PHPMailer();
$subject = "Hazard Closed";
$content = "<b>Bula Reporter</br><br>Your Hazard related to, ".$relatedto." is closed, please reply via this email if you would like more information";
$mail->IsSMTP();
$mail->SMTPDebug = 3;
$mail->SMTPAuth = TRUE;
$mail->SMTPSecure = "tls";
