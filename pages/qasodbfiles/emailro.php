...
$content = "<b>Bula ".$ro."</br><br>You have a new hazard with risk Level ".$rl." for your perusal, please login at: http://10.99.100.29/srm/index.html to view the hazard</b>";
$mail->IsSMTP();
$mail->SMTPDebug = 3;
$mail->SMTPAuth = TRUE;
$mail->SMTPSecure = "tls";
