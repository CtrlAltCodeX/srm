          ...
          <div class="box">
            ...
            <div class="box-body">
			 ...
			 $queryalert = "SELECT count(*)FROM compliance  WHERE RISKOWNER='$pageuser' AND STATUS='OPEN' AND CLOSEDRO='OPEN'";
						...
						$queryalerttwo1 = "SELECT count(*)FROM audit  WHERE RISKOWNER='$pageuser' AND STATUS='OPEN' AND CLOSEDRO='OPEN' ";
						...
						$queryalert234 = "SELECT count(*)FROM audit  WHERE RISKOWNER='$pageuser' AND RISK_LEVEL='High Risk' AND STATUS='OPEN' AND CLOSEDRO='OPEN'";
						...
						$queryalert234m = "SELECT count(*)FROM audit  WHERE RISKOWNER='$pageuser' AND RISK_LEVEL='Medium Risk' AND STATUS='OPEN' AND CLOSEDRO='OPEN'";
						...
						$queryalert234ml = "SELECT count(*)FROM audit  WHERE RISKOWNER='$pageuser' AND RISK_LEVEL='Low Risk' AND STATUS='OPEN' AND CLOSEDRO='OPEN'";
						...
						$queryalert2mlptdq = "SELECT count(*) FROM audit  WHERE RISKOWNER='$pageuser' AND TARGETDATE < CURDATE() AND STATUS='OPEN' AND CLOSEDRO='OPEN'";
						...
						$queryalert2mlptdtz = "SELECT count(*) FROM audit  WHERE RISKOWNER='$pageuser' AND (DATEDIFF(TARGETDATE,CURDATE())) BETWEEN '0' AND '30' AND STATUS='OPEN' AND CLOSEDRO='OPEN'";
						...
						$queryalert2mlptdtzq = "SELECT count(*) FROM audit  WHERE RISKOWNER='$pageuser' AND (DATEDIFF(CURDATE(),TARGETDATE)) > '30' AND STATUS='OPEN' AND CLOSEDRO='OPEN'";
						...
						$queryalert2mlptdqhumac = "SELECT count(*) FROM audit  WHERE RISKOWNER='$pageuser' AND (DATEDIFF(CURDATE(),LASTUPDATE)) > '7' AND STATUS='OPEN' AND CLOSEDRO='OPEN'";
                ...
                <tr>
                 <td>AUDIT</td>
                  <?php
						...
						$query = "SELECT SUM(IF(STATUS = 'OPEN',1,0)) AS OPEN,
									SUM(IF(STATUS = 'CLOSED',1,0)) AS CLOSED,
									COUNT(STATUS) AS 'TOTAL' FROM audit WHERE RISKOWNER = '$pageuser'";
						mysqli_query($db, $query) or die('Error querying database.');
						$result = mysqli_query($db, $query);
