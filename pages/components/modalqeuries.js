$('#myMODAL').on('show.bs.modal', function (event) {
  ...
  if(newro !== "")
  {
	 ...
	 if ($("#reasonriskowner").parent().next(".validation").length == 0) // only add if not added
     {
                $("#reasonriskowner").parent().after("<div class='validation' style='color:red;margin-bottom: 20px;'>This hazard is already transferred</div>");
     }
 ...
 if(newro !== "")
  {
	 ...
	 if ($("#morreasonriskowner").parent().next(".validation").length == 0) // only add if not added
     {
                $("#morreasonriskowner").parent().after("<div class='validation' style='color:red;margin-bottom: 20px;'>This MOR is already transferred</div>");
     }
...
$('#COMPMODAL').on('show.bs.modal', function (event) {
  ...
  if(newro !== "")
  {
	 ...
	 if ($("#compreasonriskowner").parent().next(".validation").length == 0) // only add if not added
     {
                $("#compreasonriskowner").parent().after("<div class='validation' style='color:red;margin-bottom: 20px;'>This Compliance is already transferred</div>");
     }
