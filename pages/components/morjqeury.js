      ...
      if(!(myFile==null))
		{
			...
			var dataString ={morid: morid ,caafid: caafid ,receiveddate: receiveddate ,coo:coo ,actypeseries: actypeseries ,registration: registration ,operator: operator,doo: doo ,timeoc: timeoc ,dtn: dtn  ,lpr: lpr ,fno: fno,routefrom: routefrom ,routeto: routeto ,ias: ias  ,fah: fah,iv: iv ,err: err ,nof: nof ,fp: fp  ,ds: ds ,oat: oat,ctype: ctype ,cht: cht ,cth: cth ,pw: pw ,pt: pt ,vk: vk ,icing: icing ,turbulance: turbulance ,rst: rst, rsc: rsc ,airport: airport ,hitype: hitype  ,bt: bt ,morcert:morcert,riskowner: riskowner,lastupdatedate: lastupdatedate ,updatedetails: updatedetails ,status: status ,morqaso: morqaso ,narrative: narrative,organisation: organisation ,name: name ,position: position  ,myFileName: uniquevar ,extension: extension}; 
			}
		else
			{
			
				var dataString ={morid: morid ,caafid: caafid ,receiveddate: receiveddate ,coo:coo ,actypeseries: actypeseries ,registration: registration ,operator: operator,doo: doo ,timeoc: timeoc ,dtn: dtn  ,lpr: lpr ,fno: fno,routefrom: routefrom ,routeto: routeto ,ias: ias  ,fah: fah,iv: iv ,err: err ,nof: nof ,fp: fp  ,ds: ds ,oat: oat,ctype: ctype ,cht: cht ,cth: cth ,pw: pw ,pt: pt ,vk: vk ,icing: icing ,turbulance: turbulance ,rst: rst, rsc: rsc ,airport: airport ,hitype: hitype  ,bt: bt ,morcert:morcert,riskowner: riskowner,lastupdatedate: lastupdatedate ,updatedetails: updatedetails ,status: status ,morqaso: morqaso ,narrative: narrative,organisation: organisation ,name: name ,position: position  ,myFileName: "" ,extension: ""}; 
