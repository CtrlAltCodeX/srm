...
if (!isset($_SESSION['USER'])) {
  header("Location: ../../");
} else if (!($_SESSION['USER'] == "QASO-AMO") && !($_SESSION['USER'] == "SDA") && !($_SESSION['USER'] == "CEO") && !($_SESSION['USER'] == "EXECUTIVE") && !($_SESSION['USER'] == "GMATM")) {
  header("Location: ../../");
}
$pageuser = "ANES";
?>
...
<head>
  ...
  <title>SRM PORTAL | QASO-AMO</title>
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            <a href="#"><i class="fa fa-dashboard"></i> QASO-AMO
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="amodatatables.php"><i class="fa fa-circle-o"></i> DATA ALL OPEN</a></li>
