...
{
 header("Location: ../../");
}else if (!($_SESSION['USER'] == "QASO-AMO") && !($_SESSION['USER'] == "SDA") && !($_SESSION['USER'] == "EXECUTIVE"))
{
	header("Location: ../../");
}
$pageuser="ANES";
  ...
  <ul class="sidebar-menu">
     ...
     <li class="treeview active">
              ...
              <ul class="treeview-menu">
               <li ><a href="amodashboard.php"><i class="fa fa-circle-o"></i> DASHBOARD</a></li>
								<li ><a href="amoaudit.php"><i class="fa fa-circle-o"></i> AUDIT FORM</a></li>
				<li  class="active"><a href="amodatatables.php"><i class="fa fa-circle-o"></i> DATA ALL OPEN</a></li>
				<li ><a href="amodatatables2.php"><i class="fa fa-circle-o"></i> DATA ALL CLOSED</a></li>
