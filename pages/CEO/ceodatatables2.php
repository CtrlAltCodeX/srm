...
if (!isset($_SESSION['USER'])) {
  header("Location: ../../");
} else if (!($_SESSION['USER'] == "EXECUTIVE") && !($_SESSION['USER'] == "SDA") && !($_SESSION['USER'] == "CEO")) {
  header("Location: ../../");
}
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="../../pages/CEO/ceographs.php"><i class="fa fa-circle-o"></i> GRAPHS</a></li>
              <li><a href="../../pages/CEO/ceodatatables.php"><i class="fa fa-circle-o"></i> DATA TABLES - OPEN</a></li>
              <li class="active"><a href="../../pages/CEO/ceodatatables2.php"><i class="fa fa-circle-o"></i> DATA TABLES - CLOSED</a></li>
