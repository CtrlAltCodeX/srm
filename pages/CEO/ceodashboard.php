...
if (!isset($_SESSION['USER'])) {
    header("Location: ../../");
} else if (!($_SESSION['USER'] == "CEO") && !($_SESSION['USER'] == "SDA")) {
    header("Location: ../../");
}
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="active treeview ">
                        ...
                        <ul class="treeview-menu">
                            <li class="active"><a href="../../pages/CEO/ceodashboard.php"><i class="fa fa-circle-o"></i> DASHBOARD</a></li>
                            <li><a href="../../pages/CEO/ceographs.php"><i class="fa fa-circle-o"></i> DATA GRAPHS</a></li>
                            <li><a href="../../pages/KING/execdatatables.php"><i class="fa fa-circle-o"></i> DATA TABLES - OPEN</a></li>
                            <li><a href="../../pages/KING/execdatatables2.php"><i class="fa fa-circle-o"></i> DATA TABLES - CLOSED</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li>
                                ...
                                <ul class="treeview-menu">
                                    <li><a href="../../pages/BCW/bcwdashboard.php"><i class="fa fa-circle-o"></i> DASHBOARD</a></li>
                        ...
                        <ul class="treeview-menu">
                            <li>
                                ...
                                <ul class="treeview-menu">
                                    <li><a href="../../pages/MEMS/memsdashboard.php"><i class="fa fa-circle-o"></i> DAHSBOARD</a></li>
                        ...
                        <ul class="treeview-menu">
                            <li>
                                ...
                                <ul class="treeview-menu">
                                    <li><a href="../../pages/MHR/mhrdashboard.php"><i class="fa fa-circle-o"></i> DAHSBOARD</a></li>
                        ...
                        <ul class="treeview-menu">
                            <li>
                                <a href="#"><i class="fa fa-circle-o"></i> MICT
                                    <span class="pull-right-container">
                                        <i class="fa fa-angle-left pull-right"></i>
                                    </span>
                                </a>
                                <ul class="treeview-menu">
                                    <li><a href="../../pages/mict/mictdashboard.php"><i class="fa fa-circle-o"></i> DAHSBOARD</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-header with-border">
                                ...
                                <div class="pull-right">
                                    <a href="../../uploads/MSRM/Abbreviations.pdf?= $pageuser; ?>/Abbreviations.pdf" target="_blank" class="btn btn-info btn-sm"> Abbreviations</a>
						...
						settype($looper, "integer"); */
                                    $colors = array("GMAI", "GMATM", "HOP", "MALOCS", "MANES", "MAO", "MARFFS", "MASS", "MBCW", "MC", "MEMS", "MFS", "MICT", "MNOS", "MPODC", "MSRM", "SFA");
                                    $tablerow = "";
    ...
    <script type="text/javascript">
        function dheko(verb) {
            ...
            switch (verb) {
                ...
                case 'MBCW':
                    // <!--location.href = "http://localhost/srm/pages/MAO/airsidedashboard.php"; -- >
                    window.location.href = "../../pages/BCW/bcwdashboard.php";
                    break;
                case 'OHS':
                ...
                case 'MALOCS':
                    ...
                    break;
                case 'MANES':
                    window.location.href = "../../pages/MANES/manesdashboard.php";
                    break;
                case 'MICT':
                    window.location.href = "../../pages/MICT/mictdashboard.php";
                    break;
                case 'MARFFS':
                ...
                case 'MASS':
                    ...
                    break;
                case 'MC':
                    window.location.href = "../../pages/MC/mcdashboard.php";
                    break;
                case 'MEMS':
                    window.location.href = "../../pages/MEMS/memsdashboard.php";
                    break;
                case 'MFS':
                    window.location.href = "../../pages/MFS/mfsdashboard.php";
                    break;
                case 'MPODC':
                    window.location.href = "../../pages/MHR/mhrdashboard.php";
                    break;
                case 'MSRM':
                    window.location.href = "../../pages/MSRM/msrmdashboard.php";
                    break;
                case 'GMATM':
                    window.location.href = "../../pages/GM/gmdashboard.php";
                    break;

                case 'GMAI':
                    window.location.href = "../../pages/GMAI/gmaidashboard.php";
                    break;
                    //case 'OMOIA':
                    // window.location.href = "http://10.99.100.29/srm/pages/OMOIA/omoiadashboard.php";
                    // break;
                case 'SFA':
                    window.location.href = "../../pages/SFA/sfadashboard.php";
                    break;
                case 'QASO-FIRE':
                ...
                case 'MATEI':
                    ...
                    break;
                case 'CEO':
                    window.location.href = "http://10.99.100.29/srm/pages/CEO/execdashboard.php";
