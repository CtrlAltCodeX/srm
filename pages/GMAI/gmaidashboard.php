...
if (!isset($_SESSION['USER'])) {
  header("Location: ../../");
} else if (!($_SESSION['USER'] == "GMAI") && !($_SESSION['USER'] == "SDA") && !($_SESSION['USER'] == "EXECUTIVE") && !($_SESSION['USER'] == "CEO")) {
  header("Location: ../../");
}
$pageuser = "GMAI";
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li>
            <a href="#"><i class="fa fa-dashboard"></i> <span>GMAI</span>
          ...
          <li class="treeview">
            <a href="#">
              <i class="fa fa-share"></i> <span>MANAGERS</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            ...
            <ul class="treeview-menu">
              <li>
                ...
                <ul class="treeview-menu">
                  <li><a href="../../pages/MFS/mfsdashboard.php"><i class="fa fa-circle-o"></i> DASHBOARD</a></li>
            ...
            <div class="box">
              ...
              <div class="box-body" id="tablediv">
                <div class="table-responsive">
                  ...
                  $colors = array("MNOS", "MBCW", "MEMS", "MANES", "MFS");
                  $tablerow = "";
