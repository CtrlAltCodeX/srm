...
<body class="hold-transition skin-blue sidebar-mini">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            <a href="#"><i class="fa fa-dashboard"></i> QASO-FIRE
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="fireaudit.php"><i class="fa fa-circle-o"></i> AUDIT FORM</a></li>
              <li><a href="firedatatables.php"><i class="fa fa-circle-o"></i> DATA ALL OPEN</a></li>
  ...
  <script src="../../plugins/fine-upload/jquery.fine-uploader.min.js">
  </script>
  ...
  <!-- <script src="../components/uploadEvidence.js"></script> -->
