...
if (!isset($_SESSION['USER'])) {
	header("Location: ../../");
} else if (!($_SESSION['USER'] == "QASO-FIRE") && !($_SESSION['USER'] == "SDA") && !($_SESSION['USER'] == "EXECUTIVE")) {
	header("Location: ../../");
}
				...
				<ul class="sidebar-menu">
					...
					<li class="treeview active">
						...
						<ul class="treeview-menu">
							<li><a href="firedashboard.php"><i class="fa fa-circle-o"></i> DASHBOARD</a></li>
							<li><a href="fireaudit.php"><i class="fa fa-circle-o"></i>AUDIT FORM</a></li>
							<li class="active"><a href="firedatatables.php"><i class="fa fa-circle-o"></i> DATA ALL OPEN</a></li>
							<li><a href="firedatatables2.php"><i class="fa fa-circle-o"></i> DATA ALL CLOSED</a></li>
