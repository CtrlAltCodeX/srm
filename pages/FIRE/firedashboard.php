...
if (!isset($_SESSION['USER'])) {
  header("Location: ../../");
} else if (!($_SESSION['USER'] == "QASO-FIRE") && !($_SESSION['USER'] == "SDA") && !($_SESSION['USER'] == "EXECUTIVE") && !($_SESSION['USER'] == "CEO") && !($_SESSION['USER'] == "GMATM")) {
  header("Location: ../../");
}
...
<head>
  ...
  <title>SRM PORTAL | QASO-FIRE</title>
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              <li class="active"><a href="firedashboard.php"><i class="fa fa-circle-o"></i> DASHBOARD</a></li>
