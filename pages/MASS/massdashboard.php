...
if (!isset($_SESSION['USER'])) {
  header("Location: ../../");
} else if (!($_SESSION['USER'] == "MASS") && !($_SESSION['USER'] == "SDA") && !($_SESSION['USER'] == "EXECUTIVE") && !($_SESSION['USER'] == "CEO") && !($_SESSION['USER'] == "GMATM") && !($_SESSION['USER'] == "GMA")) {
  header("Location: ../../");
}
$pageuser = "MASS";
?>
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            <a href="../../pages/MASS/massdashboard.php"><i class="fa fa-dashboard"></i> MASS
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li class="active"><a href="massdashboard.php"><i class="fa fa-circle-o"></i> HAZARD</a></li>
