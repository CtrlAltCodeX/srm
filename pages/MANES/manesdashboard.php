...
if (!isset($_SESSION['USER'])) {
  header("Location: ../../");
} else if (!($_SESSION['USER'] == "MANES") && !($_SESSION['USER'] == "SDA") && !($_SESSION['USER'] == "EXECUTIVE") && !($_SESSION['USER'] == "CEO") && !($_SESSION['USER'] == "GMAI") && !($_SESSION['USER'] == "GMATM")) {
  header("Location: ../../");
}
$pageuser = "MANES";
?>
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            <a href="../../pages/MANES/manesdashboard.php"><i class="fa fa-dashboard"></i> MANES
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li class="active"><a href="manesdashboard.php"><i class="fa fa-circle-o"></i> HAZARD</a></li>
