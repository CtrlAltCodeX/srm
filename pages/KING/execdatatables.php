        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="../../pages/KING/execdatatables.php"><i class="fa fa-circle-o"></i> DATA TABLES - OPEN</a></li>
                  ...
                  <table id="example66" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      $query = "SELECT DISTINCT(AID),RISK_LEVEL, DATEDIFF(recommendations.TARGETDATE,CURDATE()) as DiffDate, DATEDIFF(CURDATE(),audit.LASTUPDATE) as LastUpdateDiff
						FROM audit,recommendations  WHERE audit.AID=recommendations.ID AND audit.CLOSEDRO='OPEN' AND recommendations.STATUS='OPEN' GROUP BY AID";
