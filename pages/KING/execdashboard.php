        ...
        <ul class="sidebar-menu">
          ...
          <li class="active treeview ">
            ...
            <ul class="treeview-menu">
              <li class="active"><a href="../../pages/KING/execdashboard.php"><i class="fa fa-circle-o"></i> DASHBOARD</a></li>
              <li><a href="../../pages/KING/execgraphs.php"><i class="fa fa-circle-o"></i> DATA GRAPHS</a></li>
            ...
            <div class="box">
              ...
              <div class="box-body" id="tablediv">
                <div class="table-responsive">
                  ...
                  $colors = array("MNOS", "MBCW", "HOP", "MALOCS", "MANES", "MAO", "MARFFS", "MASS", "MC", "MEMS", "MFS", "MPODC", "MICT", "MSRM", "SFA");
                  $tablerow = "";
    ...
    function dheko(verb) {
      ...
      switch (verb) {
        ...
        case 'MAO':
          ...
          window.location.href = "http://10.99.100.29/srm/pages/MAO/airsidedashboard.php";
          break;
        case 'MBCW':
          // <!--location.href = "http://localhost/srm/pages/MAO/airsidedashboard.php"; -- >
        ...
        case 'SDA':
          ...
          break;
        case 'MNOS':
          window.location.href = "http://10.99.100.29/srm/pages/APMNA/apmnadashboard.php";
          break;
        case 'HOP':
          window.location.href = "http://10.99.100.29/srm/pages/HOP/chopdashboard.php";
          break;
        case 'MALOCS':
          window.location.href = "http://10.99.100.29/srm/pages/MALOCS/malocsdashboard.php";
          break;
        case 'MANES':
        ...
        case 'MICT':
          ...
          break;
        case 'MARFFS':
          window.location.href = "http://10.99.100.29/srm/pages/MARFFS/marffsdashboard.php";
          break;
        case 'MASS':
          window.location.href = "http://10.99.100.29/srm/pages/MASS/massdashboard.php";
          break;
        case 'MC':
