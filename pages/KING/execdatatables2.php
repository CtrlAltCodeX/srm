...
if (!isset($_SESSION['USER'])) {
  header("Location: ../../");
} else if (!($_SESSION['USER'] == "EXECUTIVE") && !($_SESSION['USER'] == "SDA")) {
  header("Location: ../../");
}
...
<body class="hold-transition skin-blue sidebar-mini">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            ...
            <a href="#"><i class="fa fa-dashboard"></i> <span>EXECUTIVE</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li><a href="../../pages/KING/execdashboard.php"><i class="fa fa-circle-o"></i> DASHBOARD</a></li>
              <li><a href="../../pages/KING/execgraphs.php"><i class="fa fa-circle-o"></i> GRAPHS</a></li>
              <li><a href="../../pages/KING/execdatatables.php"><i class="fa fa-circle-o"></i> DATA TABLES - OPEN</a></li>
              <li class="active"><a href="../../pages/KING/execdatatables2.php"><i class="fa fa-circle-o"></i> DATA TABLES - CLOSED</a></li>
        ...
        <div class="row">
          ...
          <div class="col-xs-12">
                  ...
                  <table id="example3" class="table table-bordered table-striped ">
                    ...
                    <tbody>
                      ...
                      $query = "SELECT *, DATEDIFF(CURDATE(),SDCSUBMITDATE ) as DiffDate, DATEDIFF(CURDATE(),LASTUPDATE) as LastUpdateDiff
						FROM hazardreport  WHERE  STATUS='CLOSED'";
            ...
            <div class="box box-primary">
              ...
              <div class="box-header">
                <h3 class="box-title">All Closed Compliance Issues</h3>
              </div>
              <!-- /.box-header -->
              <div class="box-body" id="tablediv">
                <div class="table-responsive">
                  <table id="example77" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      $query = "SELECT *, DATEDIFF(TARGETDATE ,CURDATE()) as DiffDate, DATEDIFF(CURDATE(),LASTUPDATE) as LastUpdateDiff
						FROM compliance  WHERE STATUS='CLOSED'";
                      mysqli_query($db, $query) or die('Error querying database.');
                      $result = mysqli_query($db, $query);
                  ...
                  <table id="example66" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      $query = "SELECT DISTINCT(AID),RISK_LEVEL, DATEDIFF(recommendations.TARGETDATE,CURDATE()) as DiffDate, DATEDIFF(CURDATE(),audit.LASTUPDATE) as LastUpdateDiff
						FROM audit,recommendations  WHERE audit.AID=recommendations.ID AND audit.CLOSEDRO='CLOSED' AND recommendations.STATUS='CLOSED' GROUP BY AID";
  ...
  <script>
    ...
    =
    $(this)
    modal.find('.modal-title').text('More
    details
    for
    compliance
    ID
  ...
  <tbody>";
    ...
    for(var i=0; i<len; i++) { var compid=html[i].compid; var updatedate=html[i].updatedate; var updatecontent=html[i].updatecontent; var person=html[i].person; var link=html[i].link; var tr_str="<tr>" + "<td >" + compid + "</td>" + "<td >" + updatedate + "</td>" + "<td >" + updatecontent + "</td>" + "<td >" + person + "</td>" + "<td >" + link + "</td>" + "</tr>" ; $("#updateupdatecompwa").append(tr_str); } var tr_strqw="</tbody><tfoot><tr>" + "<th >ID</th>" + "<th >Update Date</th>" + "<th>Update Content</th>" + "<th>Person</th>" + "<th>Evidence</th>" + "</tr></tfoot><tbody>" ; $("#updateupdatecompwa").append(tr_strqw); }, error: function (html) { console.log (html); } }); }) </script>
